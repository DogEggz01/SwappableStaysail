...
## Removable & Swappable Staysails
- Any staysail attached to a stay can now be removed by pressing **R** once the sail is fully furled.
  - Removing it creates a physical **sail package** that can be carried and moved around.
  - The package is named using the **stay name + sail name + sail size**.
  - The package retains the sail's weight.
- To install a staysail, hold its package, aim at its assigned stay, and press **R**.
  - Different staysails can be swapped on the same stay.
